...
async function onRequestPost7({ request }) {
  ...
  try {
    ...
    const lighthouse = psiData.lighthouseResult;
    const performanceScore = Math.round(lighthouse.categories.performance.score * 100);
    const getPerformanceGrade = /* @__PURE__ */ __name((score) => {
...
// ../.wrangler/tmp/pages-bbtDkE/functionsRoutes-0.915195584129515.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-qnG0oo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-qnG0oo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4859135826288201.mjs.map
