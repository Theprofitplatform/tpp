...
#############################################
# VPS Blog Automation - Optimized Version
# Uses simplified features to prevent timeouts
#############################################
...
main() {
    ...
    log "========================================="
    log "TPP Blog Automation Starting (Optimized)"
    log "========================================="
    ...
    # -----------------------------------------
    # 3. GENERATE BLOG POST (OPTIMIZED)
    # -----------------------------------------
    log "Step 3: Generating blog post with optimized features..."
    ...
    while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
        ...
        # Use simplified features to prevent timeouts
        export ENABLE_READABILITY_ENHANCEMENT="false"
        export ENABLE_CHART_GENERATION="false"
        export ENABLE_STATISTICS_ENRICHMENT="false"
...
Via VPS automation system (Optimized Version)"
