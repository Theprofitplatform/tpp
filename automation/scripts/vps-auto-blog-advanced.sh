...
#############################################
# VPS Blog Automation - Advanced Version
# Full features with proper timeout handling
#############################################
...
main() {
    ...
    log "========================================="
    log "TPP Blog Automation Starting (Advanced)"
    log "========================================="
    ...
    # -----------------------------------------
    # 3. GENERATE BLOG POST (FULL FEATURES)
    # -----------------------------------------
    log "Step 3: Generating blog post with full advanced features..."
    ...
    while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
        ...
        export ENABLE_READABILITY_ENHANCEMENT="true"
        export ENABLE_CHART_GENERATION="true"
        export ENABLE_STATISTICS_ENRICHMENT="true"

        # Use extended timeout for full features
        if timeout $API_TIMEOUT node automation/scripts/generate-blog-post.js >> "$LOG_FILE" 2>&1; then
            log_success "Blog post generated with full features"
...
Via VPS automation system (Advanced Version)"
