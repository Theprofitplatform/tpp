...
(function() {
    ...
    class InlineNavigation {
        ...
        openDropdown(dropdown) {
            ...
            // Calculate position to ensure dropdown appears outside nav container
            if (menu) {
        ...
        closeDropdown(dropdown) {
            ...
            // Simply remove active class and let CSS handle the rest
