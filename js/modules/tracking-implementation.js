...
class TrackingImplementation {
    ...
    loadFacebookPixel() {
        ...
        !(f,b,e,v,n,t,s) {
            if(f.fbq)return;n=f.fbq=(){n.callMethod?
...
export default TrackingImplementation;

// Performance tracking
track('module_loaded', { module: 'tracking-implementation' });