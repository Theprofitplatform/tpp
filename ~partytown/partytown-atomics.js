...
(e => {
  ...
  (!(function (e) {
    ((e[(e.MainDataRequestFromWorker = 0)] = 'MainDataRequestFromWorker'),
      ...
      (e[(e.MainInterfacesRequestFromWorker = 2)] = 'MainInterfacesRequestFromWorker'),
      (e[(e.MainInterfacesResponseToWorker = 3)] = 'MainInterfacesResponseToWorker'),
      (e[(e.InitializedWebWorker = 4)] = 'InitializedWebWorker'),
      (e[(e.InitializeEnvironment = 5)] = 'InitializeEnvironment'),
      (e[(e.InitializedEnvironmentScript = 6)] = 'InitializedEnvironmentScript'),
    ...
    (function (e) {
      ((e.document = 'd'), (e.documentElement = 'e'), (e.head = 'h'), (e.body = 'b'));
    })(w || (w = {})),
    (function (e) {
      ((e[(e.SetValue = 0)] = 'SetValue'), (e[(e.GlobalConstructor = 1)] = 'GlobalConstructor'));
    })($ || ($ = {})),
    (function (e) {
  ...
  const C = (e, t) => {
      if (e) return ((t = y.get(e)) || (t = e[p]) || A(e, (t = a())), t);
    },
    R = (e, t, r, n, i) => {
      if ((r = f[e]) && r.U) {
        if (e === t) return r.U;
        if (((n = r.U.document), (i = t.split('.').pop()) === w.document)) return n;
        if (i === w.documentElement) return n.documentElement;
        if (i === w.head) return n.head;
        if (i === w.body) return n.body;
      }
      return h.get(t);
    },
    A = (e, t, r) => {
        ...
        ? 'string' === o || 'number' === o || 'boolean' === o || null == t
          ...
          : 'function' === o
            ...
            : (r = r || new Set()) && Array.isArray(t)
              ? r.has(t)
                ? [I.Array, []]
                : r.add(t) && [I.Array, t.map(t => B(e, t, r))]
              : 'object' === o
                ? j(t)
                  ? [I.Error, { name: t.name, message: t.message, stack: t.stack }]
                  : '' === (a = n(t))
                    ? [I.Object, {}]
                    : 'Window' === a
                      ? [I.Instance, [e, e]]
                      : 'HTMLCollection' === a || 'NodeList' === a
                        ? [I.NodeList, Array.from(t).map(t => B(e, t, r)[1])]
                        : a.endsWith('Event')
                          ? [I.Event, D(e, t, r)]
                          : 'CSSRuleList' === a
                            ? [I.CSSRuleList, Array.from(t).map(W)]
                            : i(a, 'CSS') && a.endsWith('Rule')
                              ? [I.CSSRule, W(t)]
                              : 'CSSStyleDeclaration' === a
                                ? [I.CSSStyleDeclaration, D(e, t, r)]
                                : 'Attr' === a
                                  ? [I.Attr, [t.name, t.value]]
                                  : t.nodeType
                                    ? [I.Instance, [e, C(t), s(t), c]]
                                    : [I.Object, D(e, t, r, !0, !0)]
                : void 0
        : t,
    D = (e, t, r, i, s, a, c, l) => {
      if (((a = {}), !r.has(t)))
        for (c in (r.add(t), t))
          o(c) &&
            ...
            (i || 'function' != typeof l) && (s || '' !== l) && (a[c] = B(e, l, r)));
      return a;
    },
    W = e => {
      let t,
  ...
  const j = t => {
      var r;
      return ((O = (null === (r = e.top) || void 0 === r ? void 0 : r.Error) || O), t instanceof O);
    },
    U = (t, r, n, i) =>
      r
        ? ((n = r[0]),
    ...
    F = (e, { V: t, w: r, L: n }, i) => (
      (i = g.get(n)) ||
        ((i = function (...i) {
          e.postMessage([v.RefHandlerCallback, { V: t, w: r, L: n, R: B(t, this), b: B(t, i) }]);
        }),
        g.set(n, i)),
      i
    ),
    ...
    q = 'cssText,selectorText,href,media,namespaceURI,prefix,name,conditionText'.split(','),
    _ = async (e, t) => {
      let n,
        i,
        o,
      ...
      for (; d < u; d++)
        try {
          ((c = d === u - 1),
            ...
            o[0] === $.GlobalConstructor && o[1] in f[i].U
              ? A(new f[i].U[o[1]](...U(e, o[2])), n.w)
              : ((s = R(i, n.w)),
                s
                  ? ((a = J(e, i, s, o, c, n.r)),
                    n.d &&
                    ...
                    'object' == typeof (p = a) && p && p.then && ((a = await a), c && (l.z = !0)),
        ...
        try {
          if (!Array.isArray(c))
            if ('string' == typeof l || 'number' == typeof l) {
              if (m + 1 === h && a) return ((p = {}), a.map(e => (p[e] = i[e])), p);
              i = i[l];
            } else {
              if (c === $.SetValue) return void (i[u] = U(e, l));
              if (
                'function' == typeof i[u] &&
                ((d = U(e, l)),
                'define' === u && 'CustomElementRegistry' === n(i) && (d[1] = H(t, e, d[1])),
                'insertRule' === u && d[1] > r(i.cssRules) && (d[1] = r(i.cssRules)),
                (i = i[u].apply(i, d)),
                'play' === u)
              )
        ...
        ? ((n = c.querySelector(p)),
          ...
          n
            ? ((n.dataset.ptid = i = C(n, s)),
              (o = { V: s, w: i }),
              n.src ? ((o.S = n.src), (o.H = n.dataset.ptsrc || n.src)) : (o.j = n.innerHTML),
            ...
            : (t.x ||
                ...
                ((e, t, n) => {
                  let i,
                    ...
                    c = (r, n) =>
                      e.postMessage([v.ForwardMainTrigger, { V: t, q: r, b: B(t, Array.from(n)) }]);
                  if (
                    ((n._ptf = void 0),
                    a.map(e => {
                                  ...
                                  if (i) {
                                    const { methodOrProperty: t, thisObject: r } = ((e, t) => {
                                      ...
                                      return {
                                        thisObject: r,
                                        methodOrProperty:
                                          t.length > 0 ? r[t[t.length - 1]] : void 0,
                                      };
                                    })(n, s);
      ...
      if (!y.has(r)) {
        ...
        ((i.pushState = (e, t, r) => {
          ...
          (i.replaceState = (e, t, r) => {
            (d(e, t, r), c(p(S.ReplaceState, e, null == r ? void 0 : r.toString())));
          }),
    ...
    Y = () => {
      const e = Object.getOwnPropertyNames(M)
        .map(e =>
          ((e, t, r, n) => {
        ...
        .filter(
          e => !(!e || ('HTMLUnknownElement' === n(e) && 'UNKNOWN' !== e.nodeName.toUpperCase()))
        )
        .map(e => [e]);
      return X(e, []);
    },
        ...
        o(r) &&
          ...
          ('function' == (s = typeof (i = t[r]))
            ...
            : 'object' === s && null != i
              ...
              : 'symbol' !== s &&
                (r.toUpperCase() === r ? e.push([r, b.Property, i]) : e.push([r, b.Property])));
      } catch (e) {
        console.warn(e);
      }
    },
  ...
  (async e => {
    ...
    return (n, i) => {
      ...
      if (o === v.MainDataRequestFromWorker) {
        const e = (() => {
          const e = x.createElement('i'),
            t = x.createTextNode(''),
            r = x.createComment(''),
            n = x.createDocumentFragment(),
            i = x.createElement('p').attachShadow({ mode: 'open' }),
            o = te(M, 'IntersectionObserver'),
            s = te(M, 'MutationObserver'),
            a = te(M, 'ResizeObserver'),
            c = M.performance,
            l = M.screen,
            u = [
              [M.history],
              ...
              [l.orientation],
              [M.visualViewport],
              [o, b.EnvGlobalConstructor],
              [s, b.EnvGlobalConstructor],
              [a, b.EnvGlobalConstructor],
              [t],
              [r],
              [n],
              [i],
            ...
            m = { i: p, v: X(u, d), C: new URL(P, M.location) + '', I: origin, $tabId$: M._pttab };
          return (
            ((e, t, r) => {
              void 0 !== t[r] &&
                e.push([
                  r,
                  'Object',
                  Object.keys(t[r].prototype).map(e => [e, b.Property]),
                  b.EnvGlobalConstructor,
                ]);
            })(m.v, M, 'IntersectionObserverEntry'),
            m
          );
        })();
    ...
    e &&
      ...
      M.addEventListener('pt1', e => K(re, C(e.detail.frameElement), e.detail)));
  });
})(window);
