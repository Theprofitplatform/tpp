...
(e => {
  ...
  const C = (e, t) => {
      const o = {
          getContext: {
            value(e, t) {
              return (this[d] || (this[d] = (e.includes('webgl') ? g : h)(this, e, t)), this[d]);
            },
          },
        },
        l = S(
        ...
        h = (e, t, o) => {
          const i = e[a],
            ...
            m = {
              ...
              set: (e, t, r) => (
                'string' == typeof t && t in h
                  ? (h[t] !== r && 'function' != typeof r && n(f, [t], r), (h[t] = r))
                  : (e[t] = r),
                !0
              ),
            };
            ...
            h = {
              ...
              set: (e, t, r) => (
                'string' == typeof t && t in f
                  ? (f[t] !== r && 'function' != typeof r && n(l, [t], r), (f[t] = r))
                  : (e[t] = r),
                !0
              ),
            };
        ...
        p = e =>
          e.startsWith('create') || e.startsWith('get') || e.startsWith('is') || m.includes(e)
            ? R.Blocking
            : R.NonBlocking;
      (S(t, 'CanvasGradient', l), S(t, 'CanvasPattern', f), i(t.HTMLCanvasElement, o));
    },
    w = (e, u, d, b) => {
      var y, v;
      b.Audio = k(
      ...
      const B = class extends e {
        ...
        N = S(
          ...
          class extends Array {
            ...
            addEventListener(...e) {
              r(this[l], ['sourceBuffers', 'addEventListener'], e, R.NonBlockingNoSideEffect);
            }
            removeEventListener(...e) {
              r(this[l], ['sourceBuffers', 'removeEventListener'], e, R.NonBlockingNoSideEffect);
            }
          }
        ),
        T = S(
      ...
      S(
        ...
        class extends u {
          ...
          removeSourceBuffer(e) {
            const t = C(e);
            t > -1 && (this[h].splice(t, 1), r(this, ['removeSourceBuffer'], [t], R.Blocking));
          }
